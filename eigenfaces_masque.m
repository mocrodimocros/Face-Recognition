...
p = nb_colonnes * nb_lignes;
%individu_moyen = ...
individu_moyen_masque = mean(X_masque,1);
...
%Sigma2 = ...
Sigma2m = X_centre_masque * transpose(X_centre_masque)/n;
...
Vm = transpose(X_centre_masque) * V2m;
% Tri par ordre décroissant des valeurs propres de Sigma2 :
[valsDm , Im] = sort(diag(Dm),'descend');
